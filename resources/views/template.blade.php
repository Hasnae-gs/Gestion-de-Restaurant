    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="mes_plats">
              <i class="material-icons">dashboard</i>
              <p>Plats</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="add_plat">
              <i class="material-icons">person</i>
              <p>Ajouter Plat</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="{{route('showcmd')}}">
              <i class="material-icons">content_paste</i>
              <p>Commandes</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="add_pub">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="{{route('showres')}}">
              <i class="material-icons">library_books</i>
              <p>reservation</p>
            </a>
          </li>
