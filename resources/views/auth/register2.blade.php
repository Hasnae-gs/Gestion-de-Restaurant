                ...
                <div class="card-body">
                    ...
                    @endisset
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="entrer votre mot de passe">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="adresse" type="text" class="form-control @error('adresse') is-invalid @enderror" name="adresse" value="{{ old('adresse') }}" required autocomplete="adresse"placeholder="entrer votre adresse" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tele" type="integer" class="form-control @error('tele') is-invalid @enderror" name="tele" value="{{ old('tele') }}" required autocomplete="tele"  placeholder="entrer votre numero de telephone" align="" autofocus>
